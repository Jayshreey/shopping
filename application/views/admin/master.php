                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a href="<?php echo base_url('manage/sub_category')?>"><i class="icon-tasks"></i><span class="hidden-tablet"> Sub Category</span></a></li>
                            <li><a href="<?php echo base_url('manage/sub_sub_category')?>"><i class="icon-edit"></i><span class="hidden-tablet"> Sub Sub Caregory</span></a></li> 

...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <i class="icon-edit"></i>
            <a href="<?php echo base_url('edit/sub_category/'.$category_info_by_id->id)?>">Edit Sub Category</a>
        </li>
    </ul>
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="<?php echo base_url('update/sub_category/'.$category_info_by_id->id);?>" method="post" enctype="multipart/form-data">
                    <fieldset>

                        <div class="control-group">
                            <label class="control-label" for="fileInput">Sub Category Name</label>
                            <div class="controls">
                                <input class="span6 typeahead" value="<?php echo $category_info_by_id->category_name;?>" id="sub_category_name" name="sub_category_name" type="text"/>
                            </div>
                        </div>          
                        <div class="control-group">
                            <label class="control-label" for="textarea2">Sub Category Description</label>
                            <div class="controls">
                                <textarea class="cleditor" id="sub_category_description" name="sub_category_description" rows="3">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input class="span6 typeahead" name="sub_category_delete_image" value="<?php echo base_url('uploads/sub_category/'.$category_info_by_id->sub_category_image);?>" type="hidden"/>
                            </div>
                        </div>  
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <img src="<?php echo base_url('uploads/sub_category/'.$category_info_by_id->sub_category_image);?>" style="width:500px;height:200px"/>
                            </div>
                        </div> 
                        <?php } ?>
                        <div class="control-group">
